 ...
 * <ul>
 *     <li>{@link com.agentdoc.common.pojo.entity.BaseEntity#createdAt}：{@code @TableField(fill = FieldFill.INSERT)} → 插入时填充 {@code now}</li>
 *     <li>{@link com.agentdoc.common.pojo.entity.BaseLogicDeleteEntity#updatedAt}：{@code @TableField(fill = FieldFill.INSERT_UPDATE)} → 插入/更新时填充 {@code now}</li>
 * </ul>
