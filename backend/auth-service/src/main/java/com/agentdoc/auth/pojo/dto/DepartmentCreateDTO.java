...
import static com.agentdoc.auth.constant.PlatformManagementConstant.DEPARTMENT_CODE_PATTERN;
import static com.agentdoc.auth.constant.PlatformManagementConstant.MAX_DEPARTMENT_CODE_LENGTH;
...
public record DepartmentCreateDTO(
        ...
        @Size(max = MAX_DEPARTMENT_CODE_LENGTH, message = "部门编码过长")
        @Pattern(regexp = DEPARTMENT_CODE_PATTERN, message = "部门编码仅允许大写字母、数字、下划线和连字符")
        ...
        @Schema(description = "同级排序值；为空时默认 0")
        Integer sortOrder,
